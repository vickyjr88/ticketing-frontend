...
export default function UserEvents() {
    ...
    const loadEvents = async () => {
        try {
            ...
            let data = await api.getMyEvents();
    ...
    return (
        <div className="admin-page">
            <div className="admin-page-header">
                ...
                <Link to="/dashboard/events/new" className="btn-primary">
                    ...
                    filteredEvents.map((event) => (
                        <div key={event.id} className="event-card-admin">
                            ...
                            <div className="event-actions">
                                ...
                                <Link to={`/dashboard/events/${event.id}/edit`} className="action-btn edit" title="Edit Event">
